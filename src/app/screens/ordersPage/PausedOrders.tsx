          ...
          return (
            <Box key={order._id} className={"order-main-box"}>
                ...
                {order?.orderItems?.map((item: OrderItem) => {
                  ...
                  return (
                    <Box key={item._id} className={"orders-name-price"}>
                      <img src={imagePath} className={"order-cosmetic-img"} />
                      <p className={"title-cosmetic"}>{product.productName}</p>
              ...
              <Box className={"total-price-box"}>
                ...
                <Button value={order._id} variant='contained' className={"pay-button"} onClick={processOrderHandler}>
                  Payment
                </Button>
              </Box>
            </Box>
